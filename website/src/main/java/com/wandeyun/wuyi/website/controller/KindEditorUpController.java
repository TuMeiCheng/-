...
@Controller
@RequestMapping("/kindEditorUp")
public class KindEditorUpController {
    ...
    public void fileUpload(MultipartHttpServletRequest request,
            ...
            FileUploadException {
        String savePath =ClassUtils.getDefaultClassLoader().getResource("static").getPath()+"/";
        System.out.println("原生的savePath"+savePath);

        // 文件保存目录URL
        System.out.println("url："+request.getContextPath());
        //System.out.println(">>"+request.getServletContext().getRealPath("/"));
        //String saveUrl = request.getContextPath() + "/keup/";
        String saveUrl =  "http://www.5151tech.com/";
        ...
        while (itr.hasNext()) {
            ...
            System.out.println("map.get(url) >> "+msg.get("url"));
